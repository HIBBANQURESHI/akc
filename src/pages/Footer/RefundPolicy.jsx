...
<p class="mb-4">
  American Logo Maker ensures 100% customer satisfaction with our Revision Policy, which enables you to improve on your initial design concept.
</p>
...
<p class="mb-4">
  All refund requests should be communicated to the support department. American Logo Maker, based on the violation of your user agreement, reserves the right to approve/disapprove your request on an individual case-by-case basis.
</p>
...
<p class="mb-4">
  If you haven’t received a refund yet, first check your bank account again. Then contact your credit card company; it may take some time before your refund is officially posted. Next, contact your bank. There is often some processing time before a refund is posted. If you’ve done all of this and still have not received your refund, please contact us at <a href="mailto:finance@AmericanLogoMaker.com" class="text-blue-500 underline">finance@AmericanLogoMaker.com</a>.
</p>

<h2 class="text-xl font-semibold mt-6 mb-2">Exchanges/Changes (if applicable)</h2>
<p class="mb-4">
  We only replace designs if our designed logos are proven to be plagiarized from the internet. If you need to exchange it for the same item, send us an email at <a href="mailto:support@AmericanLogoMaker.com" class="text-blue-500 underline">support@AmericanLogoMaker.com</a>.
</p>
      </div>
      <Footer/>
