...
const TermsConditions = () => {
  ...
  <p class="text-gray-700 mb-4">
    American Logo Maker guarantees you unlimited revisions according to your selected package. Customers can ask for revisions as per the package and no additional fee will be charged; however, the design and concept remain the same. The revision turnaround time is 48 hours.
  </p>

  
  <h2 class="text-2xl font-semibold text-gray-800 mb-4">Refund Policy</h2>
  <p class="text-gray-700 mb-4">
    American Logo Maker ensures 100% customer satisfaction with our unlimited free revision policy, which enables you to improve your initial design brief at no additional cost.
  </p>
  <p class="text-gray-700 mb-4">
