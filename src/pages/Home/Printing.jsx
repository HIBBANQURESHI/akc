...
import bgImg from "../../assets/print-package/bg-image.jpg";
  ...
  return (
    <div className="relative">
      ...
      <div className="relative">
            ...
            <div className="flex-none mt-20 space-y-5 max-w-xl">
              ...
              <div className="flex items-center gap-x-3 sm:text-sm">
                <a
                  ...
                  className="flex items-center justify-center gap-x-1 py-4 px-5 text-white font-medium bg-yellow-500 duration-150 hover:bg-yellow-600 active:bg-gray-900 rounded-full md:inline-flex"
                >
                  Get started
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex-1 hidden md:block">
              <form class="max-w-md mx-auto p-10 border border-black">
                <div class="relative flex justify-center z-0 w-full mb-5 group">
                  <h1 className="font-bold md:text-3xl text-yellow-500">
                    Instant Quote
                  </h1>
                </div>
                ...
                <div className="flex justify-center">
                  <button
                    type="submit"
                    class="text-black mt-5 bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    Submit
                  </button>
                </div>
        ...
        <section>
          <div
            className="px-4 mx-auto bg-white p-5 border rounded-full text-center  md:max-w-screen-2xl lg:max-w-screen-2xl lg:px-30"
  ...
  <div className="max-w-screen-xl px-4 py-8 mx-auto space-y-12 lg:space-y-20 lg:py-24 lg:px-6">
    <div className="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
      <div className="text-gray-500 sm:text-lg dark:text-gray-400">
        ...
        We offer bespoke package printing services with <span className="text-yellow-500">quick turnaround and quality that speaks for itself.</span>
        </h2>
       ...
       <button className="bg-yellow-500 text-white p-3 px-5 border rounded-xl">
        get a Free Quote
       </button>
      </div>
      <img
...
<section className="bg-yellow-500 mt-10">
...
<div className="items-center m gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
      ...
      />
      <div className="text-gray-500 sm:text-lg dark:text-gray-400">
      <p className="font-normal lg:text-xl text-white" >
...
<p className="md:text-6xl flex justify-center items-center row-span-1 font-bold">Ready To Get Your Branding Done?</p>
<p className="md:text-3xl flex justify-center mt-5 items-center row-span-1 font-bold">Talk To Our Design Consultant For Free</p>
<div className="md:text-xl flex justify-center mt-5 items-center row-span-1 font-bold">
  <button className="btn bg-yellow-500 px-5 py-3 text-white mx-2 border rounded-xl">Live Chat</button>
  <button className="btn bg-white px-5 py-3 text-yellow-500 mx-2 border border-red-500 rounded-xl">Get A Free Quote</button>
</div>
<p className="md:text-3xl flex justify-center mt-5  items-center row-span-1 font-bold">or call us at <span className="mx-4 text-yellow-500"><FaPhoneAlt /></span> (800) 840-4530</p>
</section>
