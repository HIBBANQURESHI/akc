...
import app1 from "../../../assets/app-image/app-doc.png";
import app2 from "../../../assets/app-image/app-res.png";
import app3 from "../../../assets/app-image/app-commerce.png";
import app4 from "../../../assets/app-image/app-edu.png";
...
const appData = [
  { id: 1, name: 'Doctor', description: 'Connect with doctors for virtual consultations, appointments, and advice.', image: app1 },
  { id: 2, name: 'Restaurants', description: 'Discover and order from your favorite restaurants quickly and easily', image: app2 },
  { id: 3, name: 'Ecommerce', description: 'Seamless shopping experience with diverse products and secure payments online.', image: app3 },
  { id: 4, name: 'Education', description: 'An innovative app offering personalized learning and educational resources anywhere', image: app4 },
