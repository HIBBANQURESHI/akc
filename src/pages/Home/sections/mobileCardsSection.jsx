...
const appData = [
  { 
    ...
    icon1: icon4,
    name: 'Education', 
    description: 'CheckNact’s mission is to empower our customers to drive quality execution in every industry.', 
    image1: app3,
  ...
  { 
    ...
    icon1: icon3,
    name: 'Doctor', 
    description: 'DP World is a leading enabler of global trade and an integral part of the supply chain.', 
    image1: app1,
