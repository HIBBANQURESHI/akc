...
const WebDesign = () => {
  ...
  const content = {
    ...
    description: "Engage your audience with appealing website design that reflects your brand's identity.",
  ...
  const testimonials = [
    {
      name: "Alice Johnson",
      feedback: "They transformed my website completely! I'm beyond satisfied with the results.",
    },
    {
      name: "Bob Smith",
      feedback: "Excellent service and support throughout the project. Highly recommended!",
    },
    {
      name: "Charlie Brown",
      feedback: "The team was responsive and delivered on time. My site looks amazing!",
    },
  ];
  ...
  return (
    <Layout>
      ...
      <HeroService
        ...
        description="Get attractive designs for your business website that stand out."
